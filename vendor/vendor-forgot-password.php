        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            if (isset($_POST['forgotpass']))
            {
              ...
              $qry = "SELECT vendor_pass, vendor_cpass FROM vendor_detail WHERE vendor_email = '$vendor_email'";
              ...
              if ($num == 1)
              {
                $link = "<a href='http://localhost/events/vendor/vendor-reset-password.php'>link</a>";
                $_SESSION['vendor_email'] = $vendor_email;
                $qry1 = mail($vendor_email, "bookmyevents", "Click this ".$link." to change your Password",$headers);
