      ...
      <nav class="navbar navbar-expand-lg main-navbar sticky">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="profile.php" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" src="vendor_thumbnail/<?php echo $row['vendor_pic']; ?>" class="user-img-radious-style">
            <span class="d-sm-none d-lg-inline-block"></span></a>
            <div class="dropdown-menu dropdown-menu-right pullDown">
              <div class="dropdown-title">Hello <?php echo $row['vendor_fname']." ".$row['vendor_lname'] ; ?></div>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a class="nav-link" href="vendor-multiple-image-upload.php"><i data-feather="image"></i><span>Gallery</span></a>
            </li>
            <li class="dropdown">
            ...
            <li class="dropdown">
              <a href="../user/vendor-overview-details.php?vendor_detail_id=<?php echo $row['vendor_detail_id']?>" class="nav-link"><i data-feather="globe"></i><span>Website</span></a>
            </li>
            <li class="dropdown">
