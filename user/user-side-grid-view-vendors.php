					...
					<div class="col-lg-9 col-md-12 col-sm-12">
						...
						<div class="search-result-form">
							...
							<ul class="nav event-layout-btngroup">
								<li><a href="user-side-list-view-vendors.php?vendor_type=<?php echo $vendor_query_string ;?>"><i class="fas fa-th-list"></i></a></li>
												...
												<div class="event-post-meta ul-li-block mb-30">
													<ul>
														<li>
															...
															<?php echo $row['vendor_fname']." ".$row['vendor_lname']; ?>
														</li>
														<li>
															<span class="icon">
																<i class="fas fa-rupee-sign"></i>
															</span><?php echo $row['vendor_per_package_price']; ?>
														</li>
													</ul>
												</div>
