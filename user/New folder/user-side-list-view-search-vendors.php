	...
	<body class="default-header-p">
		...
		<?php
			...
			if (isset($_POST['submit_search']))
			{
				...
				$qry = "SELECT COUNT(*) FROM vendor_detail INNER JOIN vendor_master ON vendor_detail.vendor_id = vendor_master.vendor_id WHERE vendor_name LIKE '%$search%' AND vendor_type = '$vendor_query_string' AND vendor_is_active = 1";
				...
				$sql = "SELECT * FROM vendor_detail INNER JOIN vendor_master ON vendor_detail.vendor_id = vendor_master.vendor_id WHERE vendor_name LIKE '%$search%' AND vendor_type = '$vendor_query_string' AND vendor_is_active = 1 ORDER BY vendor_detail_id DESC $limit ";
				...
				{
					$previous = $pagenum - 1;
					$paginationctrls.='<li class="page-item prev-item"><a class="page-link" href="'.$_SERVER['PHP_SELF'].'?vendor_type='.$vendor_query_string.'&pn='.$previous.'">Prev</a></li>';
					...
					{ 
						if ($i > 0)
						{
							$paginationctrls.='<li class="page-item"><a class="page-link" href="'.$_SERVER['PHP_SELF'].'?vendor_type='.$vendor_query_string.'&pn='.$i.'">'.$i.'</a></li> ';
						}
					}
				}
				...
				{
					$next = $pagenum + 1;
					$paginationctrls.=' <li class="page-item next-item"><a class="page-link" href="'.$_SERVER['PHP_SELF'].'?vendor_type='.$vendor_query_string.'&pn='.$next.'">Next</a> </li>';
				}
