								...
								<div class="tab-content">
									...
									<div id="day1" class="tab-pane fade in active show">
										<ul class="nav hotal-menu">
											...
											<li><a  class="active" data-toggle="tab" href="vendor-review-details.php?vendor_detail_id=<?php echo $row['vendor_detail_id']?>"><i class="fas fa-arrow-circle-right"></i> Review</a></li>
										</ul>
										<div class="tab-content">
											...
											<div id="day1hall2" class="tab-pane fade in active show">
												<div class="hall-item clearfix">
													...
													<h3 class="event-title title-large mb-15"><?php echo $row['vendor_name']; ?>: Ratings & Reviews</h3>
													<pre></pre>
