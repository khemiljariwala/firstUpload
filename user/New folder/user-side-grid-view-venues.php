...
<body class="default-header-p">
		...
		$qry = "SELECT COUNT(*) FROM venue_detail INNER JOIN venue_master ON venue_detail.venue_id = venue_master.venue_id WHERE venue_type = '$venue_query_string' AND venue_is_active = 1";
		...
		$qry = "SELECT * FROM venue_detail INNER JOIN venue_master ON venue_detail.venue_id = venue_master.venue_id WHERE venue_type = '$venue_query_string' AND venue_is_active = '1' ORDER BY venue_detail_id DESC $limit ";
					...
					<div class="col-lg-9 col-md-12 col-sm-12">
						...
						<div class="search-result-form">
							...
							<ul class="nav event-layout-btngroup">
								<li><a href="user-side-list-view-venues.php?venue_type=<?php echo $venue_query_string ;?>"><i class="fas fa-th-list"></i></a></li>
												...
												<div class="event-post-meta ul-li-block mb-30">
													<ul>
														<li>
															...
															<?php echo $row['venue_fname']." ".$row['venue_lname']; ?>
														</li>
														<li>
															<span class="icon">
																<i class="fas fa-rupee-sign"></i>
															</span><?php echo $row['venue_per_day_price']; ?>
														</li>
													</ul>
												</div>
