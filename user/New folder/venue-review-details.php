...
<head>
	    ...
	    if (isset($_POST['save']))
	    {
	       ...
	       $ratedIndex = mysqli_real_escape_string($conn, $_POST['rate_index']);
	       $ratedIndex++;

	       if (!$uID)
	       {

	       	$qry = "INSERT INTO rating (rate_index) VALUES ('$rate_index')";
	       	$q = mysqli_query($conn, $qry); 
	       	
	       	$qry1 = "SELECT id FROM rating ORDER BY id DESC LIMIT 1";
	       ...
	       {
	       		$qry2 ="UPDATE rating SET rate_index = '$rate_index' WHERE rate_id = '$uID'"; 
	       		$q2 = mysqli_query($conn, $qry2);
	       }

	       exit(json_encode(array('rate_id => $uID'))); 	
		}


		   $qry3 = "SELECT * FROM rating";
		   $q3 = mysqli_query($conn, $qry3);
		   $num = mysqli_num_rows($q3);

		  // $qry4 = SELECT sum(rate_index) AS total FROM rating;
		  // $q3 = mysqli_query($conn, $qry4);
		...
		<title>BookYourEvents - Rating</title>
								...
								<div class="tab-content">
									...
									<div id="day1" class="tab-pane fade in active show">
										<ul class="nav hotal-menu">
											...
											<li><a  class="active" data-toggle="tab" href="venue-review-details.php?venue_detail_id=<?php echo $row['venue_detail_id']?>"><i class="fas fa-arrow-circle-right"></i> Review</a></li>
										</ul>
										<div class="tab-content">
											...
											<div id="day1hall2" class="tab-pane fade in active show">
												<div class="hall-item clearfix">
													...
													<h3 class="event-title title-large mb-15"><?php echo $row['venue_name']; ?>: Ratings & Reviews</h3>
													<pre></pre>
