...
<head>
	...
	<body class="default-header-p">
		...
		<?php
			...
			$qry = "SELECT * FROM venue_detail WHERE venue_is_active = 1 AND venue_detail_id =".$_GET['venue_detail_id'];
		...
		<section id="contact-section" class="contact-section sec-ptb-100 clearfix">
			<div class="container">
				...
				<div class="section-title mb-50">
					...
					<h2 class="big-title">Keep in touch <strong>with <?php echo $row['venue_name'] ?>!!</strong></h2>
				</div>
				<!-- section-title - end -->
				...
				<?php
						...
						if (isset($_POST['insert']))
						{
							...
							$venue_detail_id = $_GET['venue_detail_id'];
							...
							$enquiry_msg = $_POST['enquiry_msg'];
							 ...
							 $qry1 = "INSERT INTO venue_enquiry (venue_detail_id, enquiry_first_name, enquiry_last_name, enquiry_email, enquiry_mob, enquiry_date, enquiry_budget, enquiry_msg) VALUES ('$venue_detail_id','$enquiry_first_name', '$enquiry_last_name', '$enquiry_email', '$enquiry_mob', '$enquiry_date', '$enquiry_budget', '$enquiry_msg')";
