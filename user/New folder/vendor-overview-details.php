								...
								<div class="tab-content">
									...
									<div id="day1" class="tab-pane fade in active show">
										<ul class="nav hotal-menu">
											<li><a class="active" data-toggle="tab" href="vendor-overview-details.php?vendor_detail_id=<?php echo $row['vendor_detail_id']?>"><i class="fas fa-arrow-circle-right"></i> Overview</a></li>
															...
															<ul>
																<li>
																	...
																	<div class="event-content">
																		...
																		<h3 class="event-date"><?php echo $row['vendor_fname']; ?> <?php echo $row['vendor_lname']; ?></h3>
																	</div>
																</li>
																<li>
																	<span class="icon">
																	...
																	<div class="event-content">
																		<small class="event-title">Vendor Name</small>
																		<h3 class="event-date"><?php echo $row['vendor_name']; ?></h3>
																	</div>
																</li>
																<li>
																	<span class="icon">
