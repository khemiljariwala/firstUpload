...
<head>
		...
		<title>BookYourEvents - Overview</title>
								...
								<div class="tab-content">
									...
									<div id="day1" class="tab-pane fade in active show">
										<ul class="nav hotal-menu">
											<li><a class="active" data-toggle="tab" href="venue-overview-details.php?venue_detail_id=<?php echo $row['venue_detail_id']?>"><i class="fas fa-arrow-circle-right"></i> Overview</a></li>
											...
											<li><a href="venue-price-details.php?venue_detail_id=<?php echo $row['venue_detail_id']?>"><i class="fas fa-arrow-circle-right"></i> Price</a></li>
											...
											<div id="day1hall2" class="tab-pane fade in active show">
												<div class="hall-item clearfix">
													<div class="hall-content">
														<h3 class="event-title title-large mb-15">Featured Package Price </h3>
															...
															<ul>
																<li>
																	...
																	<div class="event-content">
																		<small class="event-title">Owner Name</small>
																		<h3 class="event-date"><?php echo $row['venue_fname']; ?> <?php echo $row['venue_lname']; ?></h3>
																	</div>
																</li>
																<li>
																	<span class="icon">
																	...
																	<div class="event-content">
																		<small class="event-title">Venue Name</small>
																		<h3 class="event-date"><?php echo $row['venue_name']; ?></h3>
																	</div>
																</li>
																<li>
																	<span class="icon">
																	...
																	<div class="event-content">
																		<small class="event-title">Address</small>
																		<h3 class="event-date"><?php echo $row['venue_address']; ?></h3>
																	</div>
																</li>
															</ul>
														</div>
												...
												<div class="hall-item clearfix">
													...
													<div class="hall-content">
														<h3 class="event-title title-large mb-15">Summary </h3>
														<p class="mb-30 black-color">

															<p class="addReadMore showlesscontent">

																<?php echo $row['venue_summary']; ?>
												...
												<div class="hall-item clearfix">
													...
													<div class="hall-content">
														<h3 class="event-title title-large mb-15">Terms & Condition </h3>
														<p class="mb-30 black-color">
															<p class="addReadMore showlesscontent">
																<?php echo $row['venue_tnc']; ?>
															</p>
														</p>
						...
						<div class="sidebar-section">
							...
							<div class="map-wrapper mb-30">
								...
								<div class="section-title mb-30">
									<h2 class="big-title">Venue <strong>location</strong></h2>
								</div>
								<!-- section-title - end -->
