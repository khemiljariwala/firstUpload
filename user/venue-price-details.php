...
<head>
		...
		<title>BookYourEvents - Price</title>
	...
	<!-- header-section - end
		...
		<?php 
			...
			$qry = "SELECT * FROM venue_detail INNER JOIN venue_master ON venue_detail.venue_id = venue_master.venue_id WHERE venue_is_active = 1 AND venue_detail_id =".$_GET['venue_detail_id'];
		 ...
		 <?php
		 	...
		 	$qry_images = "SELECT * FROM venue_gallery WHERE venue_detail_id =".$_GET['venue_detail_id'];
					...
					<!-- event-details - start -->
						<div class="event-details mb-80">
							...
							<div class="event-title mb-30">
								...
								<h2 class="event-title">Book Your <strong>Venue</strong></h2>
							</div>
							...
							<div id="event-details-carousel" class="event-details-carousel owl-carousel owl-theme">
								...
								<?php
									...
									if (!empty($row_images['venue_images']))
                                	{

                                		$image = $row_images['venue_images'];
                                ...
                                ?>
                                    ...
                                    <div class="item">
                                        ...
                                        <img src="../venue/venue_gallery/<?php echo $image_list[$i]; ?>" alt="Image_not_found">
                                ...
                                ?>
                                		<div class="item">
                                        	...
                                        	<img src="../venue/venue_gallery/novenuephoto.jpg" alt="Image_not_found">
							...
							<div class="section-title text-left mb-30">
								<h2 class="big-title">About <?php echo $row['venue_name']; ?></h2>
							</div>
								...
								<div class="tab-content">
									...
									<div id="day1" class="tab-pane fade in active show">
										<ul class="nav hotal-menu">
											<li><a  href="venue-overview-details.php?venue_detail_id=<?php echo $row['venue_detail_id']?>"><i class="fas fa-arrow-circle-right"></i> Overview</a></li>
											<li><a  href="venue-address-details.php?venue_detail_id=<?php echo $row['venue_detail_id']?>"><i class="fas fa-arrow-circle-right"></i> Address</a></li>
											<li><a   class="active" data-toggle="tab" href="venue-price-details.php?venue_detail_id=<?php echo $row['venue_detail_id']?>"><i class="fas fa-arrow-circle-right"></i> Price</a></li>
											<li><a  href="venue-review-details.php?venue_detail_id=<?php echo $row['venue_detail_id']?>"><i class="fas fa-arrow-circle-right"></i> Review</a></li>
										</ul>
										<div class="tab-content">
											...
											<div id="day1hall2" class="tab-pane fade in active show">
												<div class="hall-item clearfix">
													<div class="hall-content">
														<h3 class="event-title title-large mb-15"><?php echo $row['venue_name']; ?>: Rates</h3>
															...
															<ul>
																<li>
																	...
																	<div class="event-content">
																		<small class="event-title">Packages Starts From</small>
																		<h3 class="event-date"><?php echo $row['venue_per_day_price']; ?></h3>
																		<?php $venue_booking_price = 0.35 * $row['venue_per_day_price']; ?>
																		<small style="color:red;">Pay <i class="fas fa-rupee-sign"></i><?php echo $venue_booking_price ; ?> to book straight away!!!</small>
																		<br>
																		<pre>  </pre>
																	</div>
																</li>
																<li>
																	<div class="button">
																		...
																		?>
																				...
																				<a href="booking.php" class="custom-btn">Book Now</a>
																		...
																		?>
																				...
																				<a href="#alt-login-modal" class="login-modal-btn custom-btn">Book Now</a>
																...
																<li>
																	<div class="button">
																		<a href="venue-enquire-form.php?venue_detail_id=<?php echo $row['venue_detail_id']?>" class="custom-btn">Send Enquiry</a>
																	</div>
																</li>
																<br>
															</ul>
					...
					<div class="col-lg-4 col-md-12 col-sm-12">
						...
						<div class="sidebar-section">
							...
							<!-- map-wrapper - start -->
								...
								<div class="map">
									<?php echo $row['venue_map_location']; ?>
								</div>
