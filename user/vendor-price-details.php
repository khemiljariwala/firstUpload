								...
								<div class="tab-content">
									...
									<div id="day1" class="tab-pane fade in active show">
										<ul class="nav hotal-menu">
											...
											<li><a  href="vendor-address-details.php?vendor_detail_id=<?php echo $row['vendor_detail_id']?>"><i class="fas fa-arrow-circle-right"></i> Address</a></li>
											<li><a   class="active" data-toggle="tab" href="vendor-price-details.php?vendor_detail_id=<?php echo $row['vendor_detail_id']?>"><i class="fas fa-arrow-circle-right"></i> Price</a></li>
											...
											<div id="day1hall2" class="tab-pane fade in active show">
												<div class="hall-item clearfix">
													<div class="hall-content">
														<h3 class="event-title title-large mb-15"><?php echo $row['vendor_name']; ?>: Rates</h3>
															...
															<ul>
																<li>
																	...
																	<div class="event-content">
																		...
																		<h3 class="event-date"><?php echo $row['vendor_per_package_price']; ?></h3>
																		<?php $vendor_booking_price = 0.35 * $row['vendor_per_package_price']; ?>
																		<small style="color:red;">Pay <i class="fas fa-rupee-sign"></i><?php echo $vendor_booking_price ; ?> to book straight away!!!</small>
																		<br>
																		<pre>  </pre>
																	</div>
																</li>
																...
																<li>
																	<div class="button">
																		<a href="vendor-enquire-form.php?vendor_detail_id=<?php echo $row['vendor_detail_id']?>" class="custom-btn">Send Enquiry</a>
																	</div>
																</li>
																<br>
															</ul>
