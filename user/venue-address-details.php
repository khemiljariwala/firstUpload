								...
								<div class="tab-content">
									...
									<div id="day1" class="tab-pane fade in active show">
										<ul class="nav hotal-menu">
											...
											<li><a  class="active" data-toggle="tab" href="venue-address-details.php?venue_detail_id=<?php echo $row['venue_detail_id']?>"><i class="fas fa-arrow-circle-right"></i> Address</a></li>
															...
															<ul>
																<li>
																	...
																	<div class="event-content">
																		<small class="event-title">Venue Location</small>
																...
																<li>
																	...
																	<div class="event-content">
																		...
																		<h3 class="event-date"><?php echo $row['venue_mob']; ?></h3>
																	</div>
																</li>
																<br>
																<pre> </pre>
																<li>
																	...
																	<div class="event-content">
																		...
																		<h3 class="event-date"><?php echo $row['venue_email']; ?></h3>
																	</div>
																</li>
															</ul>
														</div>
