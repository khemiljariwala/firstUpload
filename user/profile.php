...
<head>
		...
		<title>BookYourEvents - Profile</title>
								...
								<div class="tab-content">
									...
									<div id="day1" class="tab-pane fade in active show">
										<ul class="nav hotal-menu">
											<li><a class="active" data-toggle="tab" href="#about"><i class="fas fa-arrow-circle-right"></i> About</a></li>
											<li><a data-toggle="tab" href="#setting"><i class="fas fa-arrow-circle-right"></i> Setting</a></li>
										</ul>
										<div class="tab-content">
													...
													<div class="hall-content">
														<div class="row">
								                          <div class="col-md-3 col-6 b-r">
								                            ...
								                            <br>
								                            <p class="text-muted"><?php echo $row['ufname']." ".$row['ulname']; ?></p>
								                          </div>
								                          <div class="col-md-3 col-6 b-r">
								                            <strong>Mobile</strong>
								                            <br>
								                            <p class="text-muted"><?php echo $row['umob']; ?></p>
								                          </div>
								                          <div class="col-md-3 col-6">
								                            <strong>Birth-date</strong>
								                            <br>
								                            <p class="text-muted"><?php echo $row['udob']; ?></p>
								                          </div>
								                          <div class="col-md-3 col-6 b-r">
								                            <strong>Email</strong>
								                            <br>
								                            <p class="text-muted"><?php echo $row['uemail']; ?></p>
								                          </div>
								                       </div>
													 </div>
												</div>
