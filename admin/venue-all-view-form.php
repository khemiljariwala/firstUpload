  ...
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
      ...
      <?php
        ...
        $venue_type_query = $_GET['venue_id'];


        $qry = "SELECT * FROM venue_detail WHERE venue_is_active = 1 AND venue_id = ".$venue_type_query;
