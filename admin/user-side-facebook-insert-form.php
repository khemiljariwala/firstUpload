    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-content">
              ...
              <div class="col-12 col-md-6 col-lg-12">
                ...
                <div class="card">
                  <div class="card-header">
                    <h4>Insert Your Facebook Page</h4>
                  </div>
                  <div class="card-body">
                    <div class="form-group col-12 col-md-6 col-lg-12">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control currency" name="facebook">
                      </div>
                  </div>
                  </div>
        ...
        if (isset($_POST['insert']))
        {
          ...
          $qry = "UPDATE website_details SET facebook = '$facebook' WHERE website_id = 0";
